...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ChatroomChannel", {
  ...
  received: function received(data) {
    ...
    document.querySelector("#message_container").append(data.user + ": " + data.body);
    document.querySelector('#submit').addEventListner("onclick", function () {
      removeAttr('disabled');
    });
  }
});
...
/******/ });
//# sourceMappingURL=application-9bae2a7df5f31ace69d5.js.map